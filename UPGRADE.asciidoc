...
You need to have your MariaDB root password next to you because several scripts will need it.
...
Password of the day sources now use access duration values to rotate password.
